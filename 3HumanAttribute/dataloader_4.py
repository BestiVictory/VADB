...
class MSRVTT_DataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        score1 = self.data['expression'].values[idx]
        score2 = self.data['movement'].values[idx]
        score3 = self.data['costume'].values[idx]
        score4 = self.data['makeup'].values[idx]


        video, video_mask = self._get_rawvideo([video_id])
        return video, video_mask, score1, score2, score3,score4, video_id
